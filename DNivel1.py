...
def hard1():
    ...
    imagen_fondo_perder = pygame.image.load( "imagen/Fondo/fondoganaste.jpg").convert()  # Cambia la ruta a la imagen de perder
    imagen_fondo_pausa = pygame.image.load(  "imagen/Fondo/fondoganaste.jpg").convert()  # Cambia la ruta a la imagen de pausa
    imagen_fondo_ganaste = pygame.image.load("imagen/Fondo/fondoganaste.jpg").convert()  # Cambia la ruta a la imagen de ganar
