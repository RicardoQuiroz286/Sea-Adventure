import pygame
import random
from NiñoFNivel3 import *
from personaje import EnemigoF, Oxigeno, JugadorH, Foca, LiberarFoca  # Importa las clases desde sprites.py
        ...
        if jugador_ganador:
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                if boton_siguiente_nivel.rect.collidepoint(mouse_pos):
                    ñoeasy3()  # Llama a la función para el siguiente nivel
