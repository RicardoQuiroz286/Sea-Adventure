...
from personaje import EnemigoF, Oxigeno, JugadorM, Tortuga, LiberarTortuga  # Importa las clases desde sprites.py
        ...
        if jugador_ganador:
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                if boton_siguiente_nivel.rect.collidepoint(mouse_pos):
                    ñaeasy2()  # Llama a la función para el siguiente nivel
