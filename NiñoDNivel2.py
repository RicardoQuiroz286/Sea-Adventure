import pygame
import random
from NiñoDNivel3 import *
from personaje import EnemigoD, JugadorH, Foca, LiberarFoca  # Importa las clases desde sprites.py
        ...
        if jugador_ganador:
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                if boton_siguiente_nivel.rect.collidepoint(mouse_pos):
                    ñohard3()  # Llama a la función para el siguiente nivel
