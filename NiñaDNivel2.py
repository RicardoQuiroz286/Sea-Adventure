import pygame
import random
from NiñaDNivel3 import *
from personaje import EnemigoD, JugadorM, Foca, LiberarFoca  # Importa las clases desde sprites.py
        ...
        if jugador_ganador:
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                if boton_siguiente_nivel.rect.collidepoint(mouse_pos):
                    ñahard3()  # Llama a la función para el siguiente nivel
