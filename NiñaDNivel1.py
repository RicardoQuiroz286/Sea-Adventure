import pygame
import random
from NiñaDNivel2 import *
from personaje import EnemigoD, Oxigeno, JugadorM, Tortuga, LiberarTortuga  # Importa las clases desde sprites.py
...
def ñahard1():
    ...
    def mostrar_contador_liberaciones(pantalla, contador):
        imagen_liberacion = pygame.image.load('imagen/tortuga/tortugacapturada1.png')
                ...
                for tortuga in tortugas:
                    if pygame.sprite.spritecollide(jugador, tortugas, False):
                        if tortuga.colision_con_jugador():
                            ...
                            liberacion = LiberarTortuga(tortuga.rect.x, tortuga.rect.y)
        ...
        if jugador_ganador:
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                if boton_siguiente_nivel.rect.collidepoint(mouse_pos):
                    ñahard2()  # Llama a la función para el siguiente nivel
