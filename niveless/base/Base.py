...
class Enemigo(pygame.sprite.Sprite):
    ...
    def __init__(self):
        super().__init__()
        # Cargar la imagen del pez globo con transparencia
        self.image = pygame.image.load("sonido/tortuga.png")
    ...
    def update(self):
        # Mover el pez globo hacia la izquierda
        self.rect.x -= self.speed
        # Si el pez globo sale de la pantalla por la izquierda, reubicarlo a la derecha
...
while ejecuta:
    ...
    # Control del audio
    # Baja volumen
    if keys[pygame.K_MINUS] and pygame.mixer.music.get_volume() > 0.0:
        pygame.mixer.music.set_volume(pygame.mixer.music.get_volume() - 0.01)
        PANTALLA.blit(sonido_abajo, (1050, 500))
    elif keys[pygame.K_MINUS] and pygame.mixer.music.get_volume() == 0.0:
        PANTALLA.blit(sonido_mute, (1050, 500))

    # Sube volumen
    if keys[pygame.K_PERIOD] and pygame.mixer.music.get_volume() < 1.0:
        pygame.mixer.music.set_volume(pygame.mixer.music.get_volume() + 0.01)
        PANTALLA.blit(sonido_arriba, (1050, 500))
    elif keys [pygame.K_PERIOD] and pygame.mixer.music.get_volume() == 1.0:
